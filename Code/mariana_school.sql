...
INSERT INTO
  visitor (email, login_password)
values
  ('administrator@gmail.com', 'admin123'),('hicham@gmail.com', 'hicham123'),('med@gmail.com', 'med123'),('test@gmail.com', 'test123');
...
values
  (
    ...
    'ADA_1',
    1
  ),('Med', 'M', 21, 'Keni', 0677889900, 'ADA_2', 2),('Test', 'F', 20, 'Casa', 06123456789, 'ADA_1', 3);
...
FROM
  ...
  visitor
WHERE
  student.idV = visitor.idV
  AND student.class = 'ADA_1';
...
FROM
  ...
  marks
WHERE
  student.idStu = marks.idStu
  and subjects.idSub = marks.idSub
  and subjects.subject_name = "math"
  and student.full_name = "hicham";
...
ALTER TABLE
  student CHANGE Hobbies Birthday DATE;
-- Delete column from table
ALTER TABLE
  student DROP COLUMN Birthday;
